...
public class HomePageController implements Initializable {
    ...
    public void switchToCleaning(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(new URL(PathConfig.RESSOURCES_ABS_PATH + "views/employee/maintenanceStaff/Maintenance-view.fxml"));
        root = loader.load();
        stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
    ...
    public void switchToProfile(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(new URL(PathConfig.RESSOURCES_ABS_PATH + "views/employee/maintenanceStaff/Profile-view.fxml"));
        root = loader.load();
        stage = (Stage) ((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
    ...
    public void confirmAction(ActionEvent event){
        ...
        int roomId = (int) (tasksTable.getSelectionModel().getSelectedItem().getRoomId());
            RoomDao.update("status","Needs Cleaning","roomId",roomId);
        }
        newTasKStatus = "";
        confirmActionPane.setVisible(false);
    ...
    public void loadDataOnComplaintsTable(List<String> responseStatusList, String  complaintDateOrder, String complaintDate, String complaintObject){
        ...
        String declarantStatus = "Maintenance Staff";
    ...
    public void addComplaint(ActionEvent event){
        ...
        if (!object.isEmpty()){
            ...
            Complaint complaint = new Complaint(declarantId,"Maintenance Staff",object,complaintBody,complaintDate,null,null);
